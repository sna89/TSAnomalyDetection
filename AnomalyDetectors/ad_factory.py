...
from Models.Lstm.LstmAE.lstm_ae import LstmAeDetector
from Models.Lstm.LstmUncertainty.lstm_uncertainty import LstmUncertaintyDetector
from Models.Lstm.LstmUncertainty.lstm_ae_uncertainty import LstmAeUncertaintyDetector
...
class AnomalyDetectionFactory:
    ...
    def get_detector(self):
        ...
        if self.detector_name == 'lstm_ae':
            return AnomalyDetector(LstmAeDetector, self.experiment_hyperparameters, self.model_hyperparameters)
            ...
            return AnomalyDetector(LstmAeUncertaintyDetector,
                                   self.experiment_hyperparameters,
                                   self.model_hyperparameters)
